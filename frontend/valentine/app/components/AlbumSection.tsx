      ...
      >
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/60 to-transparent p-4">
            <h3 className="text-white font-(--font-playfair) text-lg">
              {item.title}
            </h3>
        ...
        >
          <h3 className="text-[#7B1E3B] font-(--font-playfair) text-xl mb-4 text-center">
            {item.title}
          </h3>
          <p className="text-[#4E342E] font-(--font-inter) text-base leading-relaxed text-center">
            {item.text}
          </p>
